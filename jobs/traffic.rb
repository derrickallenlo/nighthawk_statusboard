...
office_location = URI::encode('33.687978,-117.799585')
key				= URI::encode('mgqebgsfqhswgz2ua36evv3t')
locations 	 = []
locations << { name: "Eric", location: URI::encode('33.677158,-117.852233') } # example location format
locations << { name: "Derrick", location: URI::encode('33.673417,-117.841181') } # example location format
locations << { name: "Justin & Peter", location: URI::encode('33.639169,-117.851722') } # example location format
